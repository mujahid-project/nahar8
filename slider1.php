...
<style>
    ...
    <div id="jssor_1" style=";position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <!--
            data-u="slides" width: 1300px;
        -->
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div data-p="225.00">

                <img data-u="image" src="upload/campaigns/toy2017/toy17-sale.jpg" />
                ...
                <div data-u="caption" data-t="0" style="position: absolute; top: 120px; left: 650px; width: 470px; height: 220px;">
                    <img style="position: absolute; top: 0px; left: 0px; width: 470px; height: 220px;" src="upload/campaigns/toy2017/toy17-sale.jpg" />
            ...
            <div data-p="225.00" style="display: none;">
                <img data-u="image" src="upload/campaigns/toy2017/toy17-sale1.jpg" />
            </div>
            <div data-p="225.00" data-po="80% 55%" style="display: none;">
                <img data-u="image" src="upload/campaigns/toy2017/toy17-sale2.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
        ...
        <!-- Arrow Navigator 
        class="jssora22l" dstyle="top:0px;left:8px;width:40px;height:58px;"

        -->
        <span data-u="arrowleft" class="jssora22l" style="top:0px;left:32px;width:40px;height:58px;" data-autocenter="2"></span>
